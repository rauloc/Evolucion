 ...
 * @author JUAN CARLOS
 */
public class frmUdpateDoctor extends javax.swing.JInternalFrame {


    Lista<Especialidad> lista=new Lista<>();
    Lista<Estado> listaEstado=new Lista<>();
    Doctor doctor=null;
    public frmUdpateDoctor(Doctor d) {
        initComponents();
        doctor=DoctorDAL.getInstance().buscarDoctor(d.getIdDoctor());
        cargarEspecialidad();
        cargarEstado();
        llenarDatos(doctor);
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cbespecialidad, 0, 175, Short.MAX_VALUE)
                .addContainerGap())
        );
